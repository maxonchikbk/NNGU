...
namespace WindowsFormsApplication1
{
    public partial class Form4 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //    if (n >= 7) pictureBox1.Image = (System.Drawing.Bitmap)Properties.Resources.ResourceManager.GetObject("_7x1");
            //    else pictureBox1.Image = (System.Drawing.Bitmap)Properties.Resources.ResourceManager.GetObject("_" + numericUpDown1.Value.ToString() + "x" + numericUpDown2.Value.ToString());
            //    if (k > n) pictureBox1.Image = (System.Drawing.Bitmap)Properties.Resources.ResourceManager.GetObject("_9x9");

                if (n >= 7) pictureBox1.ImageLocation = @"Resources\7x1.jpg";
                else pictureBox1.ImageLocation = @"Resources\" + numericUpDown1.Value.ToString() + "x" + numericUpDown2.Value.ToString() + ".jpg";
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            if (n >= 7) p1.StartInfo.FileName = @"Resources\7x1.jpg";           
            else p1.StartInfo.FileName = @"Resources\" + numericUpDown1.Value.ToString() + "x" + numericUpDown2.Value.ToString()+".jpg";
